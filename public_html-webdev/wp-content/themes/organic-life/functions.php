...
if(!function_exists('themeum_style')):
    ...
    function themeum_style(){
        ...
        /*    old Style wp_enqueue_style('thm-style',get_stylesheet_uri());*/
        
        wp_enqueue_style('thm-style', get_stylesheet_uri(), array(), filemtime(get_stylesheet_directory() . '/style.css'));
        wp_enqueue_style('main-css', get_template_directory_uri() . '/css/main.css', array(), filemtime(get_template_directory() . '/css/main.css'));
	...
	function themeum_plugins_include()
	{
		$plugins = array(
				...
				array(
					...
					'external_url'          => 'https://downloads.wordpress.org/plugin/the-events-calendar.3.12.6.zip', // If set, overrides default API URL and points to an external URL
				),
				array(
					...
					'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
					'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
					'external_url'          => 'https://downloads.wordpress.org/plugin/contact-form-7.4.3.1.zip', // If set, overrides default API URL and points to an external URL
				),
				array(
					'name'                  => 'Themeum Tweet',
					'slug'                  => 'themeum-tweet',
				...
				array(
					...
					'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
					'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
					'external_url'          => 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.3.0.2.zip', // If set, overrides default API URL and points to an external URL
				),
				array(
					...
					'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
					'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
					'external_url'          => 'https://downloads.wordpress.org/plugin/woocommerce.2.4.10.zip', // If set, overrides default API URL and points to an external URL
				),
				array(
